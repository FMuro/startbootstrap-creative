...
//
//  Modifications by Fernando Muro marked with (FM)
//  recommended modifications refer to those that I've found online (FM)
...
function BibtexDisplay() {
    this.fixValue = function (value) {
        ...
        // --- New recommended replacement rules (FM)
        value = value.replace(/--/g, '&ndash;');
        value = value.replace(/\\&/g, '&amp;');
        // --- My replacement rules (FM)
        value = value.replace(/\\'A/g, '&Aacute;');
        value = value.replace(/\\'E/g, '&Eacute;');
        value = value.replace(/\\'I/g, '&Iacute;');
        value = value.replace(/\\'O/g, '&Oacute;');
        value = value.replace(/\\'U/g, '&Uacute;');
        value = value.replace(/\\'a/g, '&aacute;');
        value = value.replace(/\\'e/g, '&eacute;');
        value = value.replace(/\\'i/g, '&iacute;');
        value = value.replace(/\\'o/g, '&oacute;');
        ...
        value = value.replace(/\{/g, '');
        value = value.replace(/\}/g, '');
        // --- End of my replacement rules (FM)
        return value;
    }
...
// --- Original function  (FM)
// function bibtex_js_draw() {
// $(".bibtex_template").hide();
// (new BibtexDisplay()).displayBibtex($("#bibtex_input").val(), $("#bibtex_display"));
// }

// --- New recommended function to get data from files (FM)

function bibtex_js_draw() {
    $(".bibtex_template").hide();
    $.get("./assets/bib/preprints.bib", function (data) { (new BibtexDisplay()).displayBibtex(data, $("#bibtex_display_preprints")); }, 'text');
    $.get("./assets/bib/papers.bib", function (data) { (new BibtexDisplay()).displayBibtex(data, $("#bibtex_display_papers")); }, 'text');
    $.get("./assets/bib/other.bib", function (data) { (new BibtexDisplay()).displayBibtex(data, $("#bibtex_display_other")); }, 'text');
    $.get("./assets/bib/slides.bib", function (data) { (new BibtexDisplay()).displayBibtex(data, $("#bibtex_display_slides")); }, 'text');
}
